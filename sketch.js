...
function setup() {
	...
	groundSprite.shapeColor=color(235)
...
function keyPressed(){
	...
	//rect(packageSprite.x,packageSprite.y,50,50,{restitution:1, isStatic:false})
	Matter.Body.setStatic(packageBody,false);
	Matter.Body.setStatic(boxRight,true);	
	Matter.Body.setStatic(boxBottom,true);
	Matter.body.setStatic(boxLeft,true);
	}
}
